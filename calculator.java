/* 
To use the calcuator create a class named calculator 
*/
...
String digitButtonText[] = {"7", "8", "9", "4", "5", "6", "1", "2", "3", "0", "π", "." };  
...
if(tempText.equals("π")) {
	if(cl.setClear) {
		cl.displayLabel.setText("π");
		cl.setClear=false;
	}
	else if(!isInString(cl.displayLabel.getText(),'π')) {
	cl.displayLabel.setText(cl.displayLabel.getText()+"π");
    }
}  
int index=0;  
try{  
